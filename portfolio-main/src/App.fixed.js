...
import {
  ...
  ChevronLeft, ChevronRight, X, Menu, ArrowUp, Zap, Terminal,
} from 'lucide-react';
import {
...
export default function Portfolio() {
  ...
  const [projects, setProjects] = useState([
    { id:1, title:'Mutual Fund Sahi Hai',
      description:'A website that analyzes the risk and return of mutual funds and helps investors make informed decisions.',
      tech:['MERN','AI/ML','Groq API','FastAPI','LangChain','Vercel'],
      github:'https://github.com/heavenEyes19/MutualFund-Sahi-Hai' },
    { id:2, title:'AI-Powered EdTech Ecosystem',
    ...
    { id:3, title:'Agentic AI Document Assistant',
    ...
    { id:4, title:'SkillBridge – Freelance Marketplace',
    ...
    { id:5, title:'DSA Visualizer Platform',
